...
# Purpose of this script: Simulation study of Gaussian SEP and Poisson CEP (transformed Poisson outcome)
...
if(!file.exists("gaus_poisson_t"))
{dir.create("gaus_poisson_t")}

if(!file.exists("gaus_poisson_t/MA"))
{dir.create("gaus_poisson_t/MA")}
...
if(!file.exists("gaus_poisson_t/IT"))
{dir.create("gaus_poisson_t/IT")}
...
if(!file.exists("gaus_poisson_t/IT_iter"))
{dir.create("gaus_poisson_t/IT_iter")}
