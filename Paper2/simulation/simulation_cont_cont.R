                             ...
                             path = "results_cont_cont/IT")
{
  ...
  # Model estimation
  source("D:/Users/mse0sxb18/Desktop/scripts/calculation_r_2.R")
...
if(!file.exists("results_cont_cont/IT_iter"))
  {dir.create("results_cont_cont/IT_iter")}
...
bayes_model_func <- function(x = unique(data_i[[1]]$study),
                             ...
                             SE = "S",
                             time = "year_TE",
                             path = "results_cont_cont/IT_iter")
{
  library(lme4)
  library(pbapply)
  library(parallel)
